package com.generation.pharmahealth.controller;
...
import com.generation.pharmahealth.repository.CategoriaRepository;
...
public class CategoriaController {
	...
	public ResponseEntity<List<CategoriaModel>> GetByName(@PathVariable String name){
